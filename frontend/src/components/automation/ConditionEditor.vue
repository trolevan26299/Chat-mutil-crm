<template>
  <div class="d-flex flex-column ga-3">
    <div v-for="(condition, index) in modelValue" :key="index" class="d-flex ga-2 align-center flex-wrap">
      ...
      />
      <v-select
        v-if="condition.field === 'contact.aiAutoReply'"
...
const boolOptions = [
  { title: 'Đã bật (true)', value: 'true' },
  { title: 'Chưa bật (false)', value: 'false' },
];
...
const fieldOptions = [
  ...
  { title: '🤖 AI Auto-Reply (đã bật)', value: 'contact.aiAutoReply' },
